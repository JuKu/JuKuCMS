                        ...
                        <tbody>
                            {foreach $pagelist page}
                                <tr>
                                    ...
                                    <td>{$page.actions}
                                        {if $page.locked == true}
                                            <button type="button" class="btn  disabled" title="Page was locked from user {$page.locked_user} at {$page.locked_timestamp}">Locked  <i class=" fa fa-wrench"></i></button><!-- fa-lock fa-wrench -->
                                        {/if}
                                    </td>
                                </tr>
                            {/foreach}
