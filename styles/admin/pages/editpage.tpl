            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <input type="checkbox" name="has_custom_template" id="customTplCheckbox" style="padding-left: 10px; padding-top: 10px; "{if $page.has_custom_template == true} checked="checked"{/if} />
                        </div>
                        <div class="col-sm-9">
