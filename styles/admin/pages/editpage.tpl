    ...
    <form action="{$action_url}" method="post" role="form">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body pad">
                    ...
                    <textarea id="editor1" name="html_code" style="margin-top: 20px; " rows="10" cols="80">{$page.content}</textarea>
        ...
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <!-- /.box-body -->
                <div class="box-footer">
                    <button type="submit" name="Submit" value="Save" class="btn {if $page.is_published == false}btn-info{else}btn-primary{/if}{if $page.is_published == true} pull-right{/if}">{lang}Save{/lang}</button>
