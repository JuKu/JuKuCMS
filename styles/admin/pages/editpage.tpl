    ...
    <form action="{$action_url}" method="post" role="form">
        ...
        <div class="col-md-3">
            <div class="box box-info">
                ...
                <!-- form start -->
                <div class="box-body">
                    <a href="{$page.preview_url}" target="_blank" class="btn btn-success pull-right" role="button" title="Preview page">{lang}Preview{/lang} <i class=" fa fa-search"></i></button></a><br />
                    <br />
                    Publish state<br />
                    PageID: {$page.id}
                </div>
